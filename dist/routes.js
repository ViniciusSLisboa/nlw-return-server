...
const prisma_feedbacks_repositories_1 = require("./repositories/prisma/prisma-feedbacks-repositories");
...
exports.routes.post("/feedbacks", async (req, res) => {
    ...
    const prismaFeedbacksRepository = new prisma_feedbacks_repositories_1.PrismaFeedbacksRepository();
